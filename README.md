...
Functionality: **_Uses camel-http to copy this github page to file_**
...
git clone https://github.com/jammazwan/xap_HttpToFile.git
cd jammazwan.shared
mvn install 
```
...
_run XapTest to examine file generated_
...
so you can focus only on what is required to demo the **HttpToFile** feature **_in isolation_**.
...
The prefix **xap** is used for maintaining sort order in a directory, providing packaging, and is otherwise meaningless. The x stands for _example_.
